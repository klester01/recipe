...
console.log("Add "+two+" teaspoon of oil and 5 garlic cloves, cook until golden, about 2 minutes");
console.log("Add "+oneFourth+" cup of Water, "+two+" cans of crush tomatoes and salt and season with black pepper to taste");
